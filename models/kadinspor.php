...
<div class="wrapper">
        ...
        <div class="text3" style="width:100%;height:200px;margin:0 auto;text-align:center;position:absolute;">
            <img src="../img/ayakkabi4.jpg" style="width:526px; image-size:cover; margin-left: 50px;">

            <img src="../img/ayakkabi4_2.jpg" style="width:526px; image-size:cover;">

            <img src="../img/ayakkabi4_3.jpg" style="width:526px; image-size:cover;">
        </div>
</div>
<div style="width:1550px; margin:0 auto; margin-top:420px;">
    <h1 id="isim" style="font-size:45px; margin-top:110px; float:left; font-family: Poppins, sans-serif; font-weight:400;">Kinetix Kadın Spor Ayakkabı</h1>
    <p style="float:right; padding:5px; background-color:#A3A3A3; border-radius:20px; color:white; margin-top:125px; margin-left:10px; padding-left:15px; padding-right:15px; font-family: Poppins, sans-serif;">Kadın</p>
    <p style="float:right; padding:5px; background-color:#A3A3A3; border-radius:20px; color:white; margin-top:125px; margin-left:10px; padding-left:15px; padding-right:15px; font-family: Poppins, sans-serif;">Spor</p>
    <p style="float:right; padding:5px; background-color:#A3A3A3; border-radius:20px; color:white; margin-top:125px; margin-left:10px; padding-left:15px; padding-right:15px; font-family: Poppins, sans-serif;">Ayakkabı</p>
    <h1 id="price" style="font-size:25px; margin-top:160px; float:left; font-family: Poppins, sans-serif; font-weight:400; position:absolute; color:#4EB5EE;">80</h1>
    ...
    <p style="float:left; margin-top:30px; font-size:25px; font-family: Roboto, sans-serif; color:#535353; font-weight:300; margin-right: 500px">
Kinetix Bonı Mesh W Beyaz Kadın Sneaker Ayakkabı
<br>Malzeme: Tekstil
<br>Sezon: 2020 Yaz
<br>Menşei: Türkiye</p>
