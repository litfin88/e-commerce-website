...
<div class="wrapper">
        ...
        <div class="text3" style="width:100%;height:200px;margin:0 auto;text-align:center;position:absolute;">
            <img src="../img/ayakkabi3.jpg" style="width:526px; image-size:cover; margin-left: 50px;">

            <img src="../img/ayakkabi3_2.jpg" style="width:526px; image-size:cover;">

            <img src="../img/ayakkabi3_3.jpg" style="width:526px; image-size:cover;">
        </div>
</div>
<div style="width:1550px; margin:0 auto; margin-top:420px;">
    <h1 id="isim" style="font-size:45px; margin-top:110px; float:left; font-family: Poppins, sans-serif; font-weight:400;">Slazenger Erkek Spor Ayakkabı</h1>
    <h1 id="price" style="font-size:25px; margin-top:160px; float:left; font-family: Poppins, sans-serif; font-weight:400; position:absolute; color:#4EB5EE;">82</h1>
...
Ürün Kodu : SA11LE079-039
<br>Ürün Adı : Slazenger EDWIN Sneaker Erkek Ayakkabı Beyaz / Gümüş
<br>Cinsiyet : Erkek
<br>Ürün Grubu : Ayakkabı
<br>Kategorisi : Sneaker</p>
