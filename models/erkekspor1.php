...
<div class="wrapper">
        ...
        <div class="text3" style="width:100%;height:200px;margin:0 auto;text-align:center;position:absolute;">
            <img src="../img/ayakkabi2.jpg" style="width:526px; image-size:cover; margin-left: 50px;">

            <img src="../img/ayakkabi2_2.jpg" style="width:526px; image-size:cover;">

            <img src="../img/ayakkabi2_3.jpg" style="width:526px; image-size:cover;">
        </div>
</div>
<div style="width:1550px; margin:0 auto; margin-top:420px;">
    <h1 id="isim" style="font-size:45px; margin-top:110px; float:left; font-family: Poppins, sans-serif; font-weight:400;">Kinetix Cosmo Erkek Spor Ayakkabı</h1>
    <h1 id="price" style="font-size:25px; margin-top:160px; float:left; font-family: Poppins, sans-serif; font-weight:400; position:absolute; color:#4EB5EE;">90</h1>
    ...
    <p style="float:left; margin-top:30px; font-size:25px; font-family: Roboto, sans-serif; color:#535353; font-weight:300; margin-right: 500px">Kinetix Cosmo M Siyah Erkek Sneaker Ayakkabı,<br>Kullanışlı ve Kaliteli. Garanti Süresi 24 Ay. Malzeme: Tekstil</p>
