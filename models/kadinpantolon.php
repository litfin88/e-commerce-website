...
<div class="wrapper">
        ...
        <div class="text3" style="width:100%;height:200px;margin:0 auto;text-align:center;position:absolute;">
            <img src="../img/pantolon2.jpg" style="width:506px; image-size:cover; margin-left: 50px;">

            <img src="../img/pantolon2_2.jpg" style="width:506px; image-size:cover; margin-left: 50px;">
        </div>
</div>
<div style="width:1550px; margin:0 auto; margin-top:420px;">
    <h1 id="isim" style="font-size:45px; margin-top:110px; float:left; font-family: Poppins, sans-serif; font-weight:400;">Lacivert Kadın Pantolon</h1>
    ...
    <p style="float:right; padding:5px; background-color:#A3A3A3; border-radius:20px; color:white; margin-top:125px; margin-left:10px; padding-left:15px; padding-right:15px; font-family: Poppins, sans-serif;">Pantolon</p>
