...
<div class="wrapper">
        ...
        <div class="text3" style="width:100%;height:200px;margin:0 auto;text-align:center;position:absolute;">
            <img src="../img/tisort2.jpg" style="width:506px; image-size:cover; margin-left: 50px;">

            <img src="../img/tisort2_2.jpg" style="width:506px; image-size:cover;">
        </div>
</div>
<div style="width:1550px; margin:0 auto; margin-top:420px;">
    <h1 id="isim" style="font-size:45px; margin-top:110px; float:left; font-family: Poppins, sans-serif; font-weight:400;">Defacto Kadın Tişört</h1>
    ...
    <p style="float:right; padding:5px; background-color:#A3A3A3; border-radius:20px; color:white; margin-top:125px; margin-left:10px; padding-left:15px; padding-right:15px; font-family: Poppins, sans-serif;">Tişört</p>
    <h1 id="price" style="font-size:25px; margin-top:160px; float:left; font-family: Poppins, sans-serif; font-weight:400; position:absolute; color:#4EB5EE;">70</h1>
    ...
    <p style="float:left; margin-top:30px; font-size:25px; font-family: Roboto, sans-serif; color:#535353; font-weight:300; margin-right: 1000px">
DeFacto Kadın V Yakalı Kısa Kollu T-Shirt
<br><br>Tasarımı ve rahat kalıbı ile her bayanın mutlaka dolabında olması gereken, her renk pantolon ve etekle kolayca kombinlenebilen DeFacto bayan trend t-shirt.</p>
