...
<div class="wrapper">
        ...
        <div class="text3" style="width:100%;height:200px;margin:0 auto;text-align:center;position:absolute;">
            <img src="../img/pantolon1.jpg" style="width:506px; image-size:cover; margin-left: 50px;">
        </div>
</div>
<div style="width:1550px; margin:0 auto; margin-top:420px;">
    <h1 id="isim" style="font-size:45px; margin-top:110px; float:left; font-family: Poppins, sans-serif; font-weight:400;">Lacivert Erkek Pantolon</h1>
    ...
    Lufian Erkek Regular Fit Leed Spor Chino Pantolon</p>
